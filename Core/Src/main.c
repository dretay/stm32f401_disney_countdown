...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOA, EINK_RST_Pin|EINK_DC_Pin|EINK_CS_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TM1638_DIO_Pin|TM1638_CLK_Pin|TM1638_STB_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : EINK_RST_Pin EINK_DC_Pin EINK_CS_Pin */
  GPIO_InitStruct.Pin = EINK_RST_Pin|EINK_DC_Pin|EINK_CS_Pin;
