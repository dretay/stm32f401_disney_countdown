...
//pin assignments
#define RST_Pin EINK_RST_Pin
#define RST_GPIO_Port EINK_RST_GPIO_Port
#define DC_Pin EINK_DC_Pin
#define DC_GPIO_Port EINK_DC_GPIO_Port
#define BUSY_Pin EINK_BUSY_Pin
#define BUSY_GPIO_Port EINK_BUSY_GPIO_Port
#define SPI_CS_Pin EINK_CS_Pin
#define SPI_CS_GPIO_Port EINK_CS_GPIO_Port
